...
const EmptyTasksList = () => {
    return (
        <div className={cx('block-list block-list--empty')}>
            <div className={cx('empty-message')}>
                ...
                <span className={cx('empty-message__title')}>Список задач пуст</span>
                <p>Похоже у вас нет ни одной задачи!<br />Вы счастливый человек.</p>
            </div>
        </div>
    );
};
